    ...
    >
      {highlighted && (
        <div className="absolute -top-4 left-1/2 -translate-x-1/2">
          <div className="bg-gradient-to-r from-[#0070C9] to-[#002F6C] text-white px-4 py-1 rounded-full text-sm flex items-center space-x-1">
      ...
      <Button
        ...
        className={`w-full ${
          highlighted
            ? 'bg-gradient-to-r from-[#0070C9] to-[#002F6C] text-white hover:opacity-90'
