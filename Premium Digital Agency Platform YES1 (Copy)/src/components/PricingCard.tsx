    ...
    >
      {highlighted && (
        <div className="absolute -top-4 left-1/2 -translate-x-1/2">
          <div className="bg-gradient-to-r from-[#00AEEF] to-[#9333EA] text-white px-4 py-1 rounded-full text-sm flex items-center space-x-1">
      ...
      <Button
        ...
        className={`w-full ${
          highlighted
            ? 'bg-gradient-to-r from-[#00AEEF] to-[#9333EA] text-white hover:opacity-90'
