      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map((value, index) => (
            ...
            >
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#00AEEF] to-[#2563EB] flex items-center justify-center mx-auto mb-4">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="glass rounded-2xl p-8 md:p-12">
          <div className="flex items-start space-x-6">
            <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#00AEEF] to-[#2563EB] flex items-center justify-center flex-shrink-0">
