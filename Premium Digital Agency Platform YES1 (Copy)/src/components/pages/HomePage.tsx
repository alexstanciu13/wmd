    ...
    <div className="relative">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <Button
                ...
                className="bg-gradient-to-r from-[#00AEEF] to-[#2563EB] text-white hover:opacity-90 transition-opacity h-14 px-8 glow-cyan text-lg"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { icon: DollarSign, value: '$50M+', label: 'Venituri Generate', color: 'from-[#2563EB] to-blue-600' },
              { icon: BarChart3, value: '247%', label: 'Creștere ROI Medie', color: 'from-[#00AEEF] to-[#1A237E]' },
              { icon: Clock, value: '98%', label: 'Retenție Clienți', color: 'from-[#1A237E] to-[#2563EB]' },
            ].map((stat, index) => (
              <motion.div
                key={stat.label}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              >
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#00AEEF] to-[#2563EB] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {valuePillars.map((pillar, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#00AEEF] to-[#2563EB] flex items-center justify-center mb-4">
      ...
      <section className="relative py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button
            onClick={() => onNavigate('apply')}
            className="bg-gradient-to-r from-[#00AEEF] to-[#2563EB] text-white hover:opacity-90 transition-opacity h-14 px-8 text-lg glow-cyan"
          >
            Aplică pentru Colaborare
            <ArrowRight className="ml-2 w-5 h-5" />
          </Button>
