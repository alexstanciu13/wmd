    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          >
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#0070C9] to-[#002F6C] flex items-center justify-center glow-cyan">
          ...
          <div className="hidden md:block">
            <Button
              ...
              className="bg-gradient-to-r from-[#0070C9] to-[#002F6C] text-white hover:opacity-90 transition-opacity glow-cyan"
            >
              Aplică Acum
            </Button>
          </div>
        ...
        <div className="md:hidden glass-strong border-t border-white/10">
          <div className="px-4 py-6 space-y-4">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-[#0070C9] to-[#002F6C] text-white"
            >
              Aplică Acum
            </Button>
          </div>
